...
CREATE TABLE `crm_activity` (
  ...
  `ACTIVITY_CONTENT` varchar(100) DEFAULT NULL COMMENT '活动内容',
  `ACTIVITY_EFFECT` varchar(100) DEFAULT NULL COMMENT '预计效果',
  `ACTIVITY_DATE` varchar(20) DEFAULT NULL COMMENT '时间',
  `ACTIVITY_COST` int(4) DEFAULT NULL COMMENT '涉及金额 单位（万元）',
  PRIMARY KEY (`ACTIVITY_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商务活动表';
...
-- ----------------------------
-- Table structure for crm_clew
-- ----------------------------
DROP TABLE IF EXISTS `crm_clew`;
CREATE TABLE `crm_clew` (
  `CLEW_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `CLEW_NAME` varchar(20) DEFAULT NULL COMMENT '项目名称',
  `CUSTOMER_ID` int(11) DEFAULT NULL COMMENT '关联客户ID',
  `CONTACT_ID` int(11) DEFAULT NULL COMMENT '主要联系人',
  `CLEW_BUDGET` int(5) DEFAULT NULL COMMENT '预算，单位 万元',
  `CLEW_PERIOD` varchar(5) DEFAULT NULL COMMENT '阶段，代码， 关联字典CLEW_PERIOD',
  `CLEW_CREATE` date DEFAULT NULL COMMENT '创建时间',
  `CLEW_UPDATE` date DEFAULT NULL COMMENT '修改时间',
  `CLEW_CHARGE_ID` int(11) DEFAULT NULL COMMENT '销售人员ID',
  `CLEW_PROPOSAL_DATE` varchar(20) DEFAULT NULL COMMENT '预计立项时间',
  PRIMARY KEY (`CLEW_ID`)
...
CREATE TABLE `crm_competitor` (
  `COMP_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `COMP_NAME` varchar(10) DEFAULT NULL COMMENT '公司名称',
  `COMP_MAIN_BIZ` varchar(100) DEFAULT NULL COMMENT '主要产品',
  `COMP_MAIN_ADD` varchar(100) DEFAULT NULL,
  `COMP_MAIN_CUSTOMER` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`COMP_ID`)
...
CREATE TABLE `crm_contacts` (
  ...
  `CONTACT_TEL` varchar(15) DEFAULT NULL COMMENT '联系人手机',
  `CONTACT_MAIL` varchar(20) DEFAULT NULL COMMENT '联系人邮箱',
  `CUSTOMER_ID` int(11) DEFAULT NULL COMMENT '关联客户',
  `CONTACT_JOB` varchar(10) DEFAULT NULL COMMENT '职务',
...
CREATE TABLE `crm_customers` (
  ...
  `CUSTOMER_ADD` varchar(20) DEFAULT NULL COMMENT '客户所在地',
  `CUSTOMER_TRADE` varchar(5) DEFAULT NULL COMMENT '所在行业 代码，关联字典CUSTOMER_TRADE',
  `CUSTOMER_QUALITY` varchar(5) DEFAULT NULL COMMENT '客户质量 代码，关联字典CUSTOMER_QUALITY',
  `CUSTOMER_FOUND` varchar(20) DEFAULT NULL COMMENT '开发年份',
  `CUSTOMER_SCOPE` varchar(5) DEFAULT NULL COMMENT '客户规模 代码，关联字典CUSTOMER_SCOPE',
...
-- ----------------------------
-- Table structure for crm_pact
-- ----------------------------
DROP TABLE IF EXISTS `crm_pact`;
CREATE TABLE `crm_pact` (
  `PACT_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `CUSTOMER_ID` int(11) DEFAULT NULL COMMENT '客户ID',
  `PACT_STATUS` varchar(5) DEFAULT NULL COMMENT '状态，编码，关联字典PACT_STATUS',
  `PACT_SUM` int(4) DEFAULT NULL COMMENT '金额，单位（万元）',
  `PACT_REC_PAY` int(4) DEFAULT NULL COMMENT '回款，单位（万元）',
  `PACT_DATE` varchar(20) DEFAULT NULL COMMENT '生效日期',
  `SALES_ID` int(11) DEFAULT NULL COMMENT '销售负责人ID',
  `PACT_UPDATE` date DEFAULT NULL COMMENT '上次修改时间',
  PRIMARY KEY (`PACT_ID`)
...
-- ----------------------------
-- Table structure for crm_sales
-- ----------------------------
DROP TABLE IF EXISTS `crm_sales`;
CREATE TABLE `crm_sales` (
  `SALES_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `SALES_NAME` varchar(20) DEFAULT NULL COMMENT '销售人员名称',
  `SALES_PAY` int(5) DEFAULT NULL COMMENT '月薪，单位元。',
  `SALES_TEL` varchar(15) DEFAULT NULL COMMENT '联系电话',
  `SALES_MAIL` varchar(20) DEFAULT NULL COMMENT '邮箱',
  PRIMARY KEY (`SALES_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='销售人员';

-- ----------------------------
-- Records of crm_sales
-- ----------------------------
INSERT INTO `crm_sales` VALUES ('2', '李四3', '162', '130', 'mail@adsf.com');
...
INSERT INTO `sys_func` VALUES ('-1230000', '0', 'impl', '实施管理', '23', 'MENU', null, '实施管理', 'icon-cup', '1', '1', '1');
...
INSERT INTO `sys_func` VALUES ('-1220000', '0', 'sales', '营销管理', '22', 'MENU', null, '营销管理', 'icon-basket', '1', '1', '1');
INSERT INTO `sys_func` VALUES ('-1214030', '-1214000', 'manage.risk_project', '项目', '30', 'FEATURE', null, '项目', 'icon-social-dropbox', '1', '1', '1');
INSERT INTO `sys_func` VALUES ('-1214020', '-1214000', 'manage.risk_sales', '销售', '20', 'FEATURE', null, '销售', 'icon-basket', '1', '1', '1');
INSERT INTO `sys_func` VALUES ('-1214010', '-1214000', 'manage.risk_mgmt', '经营', '10', 'FEATURE', null, '经营', 'icon-briefcase', '1', '1', '1');
INSERT INTO `sys_func` VALUES ('-1214000', '-1210000', 'manage.risk_menu', '风险管理', '40', 'MENU', null, '风险管理', 'icon-fire', '1', '1', '1');
INSERT INTO `sys_func` VALUES ('-1213030', '-1213000', 'manage.cost_travel', '差旅', '30', 'FEATURE', null, '差旅', 'icon-plane', '1', '1', '1');
INSERT INTO `sys_func` VALUES ('-1213020', '-1213000', 'manage.cost_impl', '实施', '20', 'FEATURE', null, '实施', 'icon-cup', '1', '1', '1');
INSERT INTO `sys_func` VALUES ('-1213010', '-1213000', 'manage.cost_sales', '销售', '10', 'FEATURE', null, '销售', 'icon-basket', '1', '1', '1');
INSERT INTO `sys_func` VALUES ('-1213000', '-1210000', 'manage.cost_menu', '成本管理', '30', 'MENU', null, '成本管理', 'icon-pencil', '1', '1', '1');
INSERT INTO `sys_func` VALUES ('-1212000', '-1210000', 'manage.received_payments', '回款', '20', 'FEATURE', null, '回款', 'icon-magnet', '1', '1', '1');
INSERT INTO `sys_func` VALUES ('-1211030', '-1211000', 'manage.budget_impl', '实施', '30', 'FEATURE', null, '实施', 'icon-cup', '1', '1', '1');
INSERT INTO `sys_func` VALUES ('-1211020', '-1211000', 'manage.budget_sales', '营销', '20', 'FEATURE', null, '营销', 'icon-basket', '1', '1', '1');
INSERT INTO `sys_func` VALUES ('-1211010', '-1211000', 'manage.budget_mgmt', '经营', '10', 'FEATURE', null, '经营', 'icon-briefcase', '1', '1', '1');
INSERT INTO `sys_func` VALUES ('-1211000', '-1210000', 'manage.budget_menu', '预算管理', '10', 'MENU', null, '预算管理', 'icon-calculator', '1', '1', '1');
INSERT INTO `sys_func` VALUES ('-1210000', '0', 'manage', '经营管理', '21', 'MENU', null, '经营管理', 'icon-briefcase', '1', '1', '1');
...
-- ----------------------------
INSERT INTO `sys_global_variable` VALUES ('1', '10123', '系统名称', 'CRM系统', '1');
...
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 COMMENT='功能，角色关联表';

-- ----------------------------
-- Records of sys_role_func
-- ----------------------------
INSERT INTO `sys_role_func` VALUES ('1', '-1230400', '-2');
INSERT INTO `sys_role_func` VALUES ('2', '-1230300', '-2');
INSERT INTO `sys_role_func` VALUES ('3', '-1230200', '-2');
INSERT INTO `sys_role_func` VALUES ('4', '-1230100', '-2');
INSERT INTO `sys_role_func` VALUES ('5', '-1230000', '-2');
INSERT INTO `sys_role_func` VALUES ('6', '-1221000', '-2');
INSERT INTO `sys_role_func` VALUES ('7', '-1220900', '-2');
INSERT INTO `sys_role_func` VALUES ('8', '-1220800', '-2');
INSERT INTO `sys_role_func` VALUES ('9', '-1220700', '-2');
INSERT INTO `sys_role_func` VALUES ('10', '-1220600', '-2');
INSERT INTO `sys_role_func` VALUES ('11', '-1220500', '-2');
INSERT INTO `sys_role_func` VALUES ('12', '-1220400', '-2');
INSERT INTO `sys_role_func` VALUES ('13', '-1220300', '-2');
INSERT INTO `sys_role_func` VALUES ('14', '-1220100', '-2');
INSERT INTO `sys_role_func` VALUES ('15', '-1220000', '-2');
INSERT INTO `sys_role_func` VALUES ('16', '-1214030', '-2');
INSERT INTO `sys_role_func` VALUES ('17', '-1214020', '-2');
INSERT INTO `sys_role_func` VALUES ('18', '-1214010', '-2');
INSERT INTO `sys_role_func` VALUES ('19', '-1214000', '-2');
INSERT INTO `sys_role_func` VALUES ('20', '-1213030', '-2');
INSERT INTO `sys_role_func` VALUES ('21', '-1213020', '-2');
INSERT INTO `sys_role_func` VALUES ('22', '-1213010', '-2');
INSERT INTO `sys_role_func` VALUES ('23', '-1213000', '-2');
INSERT INTO `sys_role_func` VALUES ('24', '-1212000', '-2');
INSERT INTO `sys_role_func` VALUES ('25', '-1211030', '-2');
INSERT INTO `sys_role_func` VALUES ('26', '-1211020', '-2');
INSERT INTO `sys_role_func` VALUES ('27', '-1211010', '-2');
INSERT INTO `sys_role_func` VALUES ('28', '-1211000', '-2');
INSERT INTO `sys_role_func` VALUES ('29', '-1210000', '-2');
INSERT INTO `sys_role_func` VALUES ('30', '-1040700', '-2');
INSERT INTO `sys_role_func` VALUES ('31', '-1040600', '-2');
INSERT INTO `sys_role_func` VALUES ('32', '-1040500', '-2');
INSERT INTO `sys_role_func` VALUES ('33', '-1040400', '-2');
INSERT INTO `sys_role_func` VALUES ('34', '-1040300', '-2');
INSERT INTO `sys_role_func` VALUES ('35', '-1040200', '-2');
INSERT INTO `sys_role_func` VALUES ('36', '-1040100', '-2');
INSERT INTO `sys_role_func` VALUES ('37', '-1030800', '-2');
INSERT INTO `sys_role_func` VALUES ('38', '-1020900', '-2');
INSERT INTO `sys_role_func` VALUES ('39', '-1020800', '-2');
INSERT INTO `sys_role_func` VALUES ('40', '-1020700', '-2');
INSERT INTO `sys_role_func` VALUES ('41', '-1020600', '-2');
INSERT INTO `sys_role_func` VALUES ('42', '-1020500', '-2');
INSERT INTO `sys_role_func` VALUES ('43', '-1020400', '-2');
INSERT INTO `sys_role_func` VALUES ('44', '-1020300', '-2');
INSERT INTO `sys_role_func` VALUES ('45', '-1020200', '-2');
INSERT INTO `sys_role_func` VALUES ('46', '-1020100', '-2');
INSERT INTO `sys_role_func` VALUES ('47', '-1010100', '-2');
