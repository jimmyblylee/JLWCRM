...
public class DictServiceImpl implements DictService {
    ...
    public List<SysDict> queryDictsByNature(String nature) throws ServiceException {
        ...
        List<SysDict> childrenDictList =new ArrayList<SysDict>();
    ...
    public List<SysDict> queryAllDicts(int start, int limit) throws ServiceException {
        ...
        List<SysDict> list=dao.queryAll(limit < 0 ? 0 : start, limit < 0 ? Integer.MAX_VALUE : limit);
        return list;
    }
	...
	public List<SysDict> queryDictCountByLikeQuery(int start, int limit,SysDict dict) throws ServiceException {
		...
		List<SysDict> dictList =  (List<SysDict>) dao.querySysDeptByManyfields(start,limit,dict);
		
	    List<SysDict> listdict =new ArrayList<SysDict>();
	    for (int i = 0; i < dictList.size(); i++) {
	    	listdict = getParentById(dictList.get(i).getId());
			if(listdict.size() > 0){
				dictList.get(i).setChilds("childs");
			}
		}
		return dictList;
	}
	...
	public List<SysDict> queryDictChildrenByParentId(int start, int limit, int id) throws ServiceException {
		...
		List<SysDict>  queryByNamedQuery = (List<SysDict>) dao.queryChildrenDictByDictId(limit < 0 ? 0 : start, limit < 0 ? Integer.MAX_VALUE : limit,id);
	...
	public Integer querySysDictByManyfieldsCount(SysDict dict) throws ServiceException {
		...
		int	totle = dao.getCountByNamedQuery(dict);
		return totle;
	}
    ...
    public List<SysDict> getParentById(int id) throws ServiceException {
        List<SysDict> list=dao.getParentById(id);       
        return list;
    }
	...
	public List<SysDict> queryDictCountByOrderBy(int start, int limit,SysDict dict) throws ServiceException {
		...
		List<SysDict> dictList =  (List<SysDict>) dao.querySysDeptByOrderBy(start,limit,dict);
