...
function UsertableCtrl($scope, $http, $q, $filter, $modal, $timeout,$aside) {
	...
	var userInfoPage = $modal({
		scope : $scope,
		templateUrl : 'packages/sys/views/user/userInfo.html',
		show : false,
		container : '#userlist',
	...
	var updateUserInfoPage = $modal({
		scope : $scope,
		templateUrl : 'packages/sys/views/user/updateUserInfo.html',
		show : false,
		container : '#userlist',
		controller : 'userInfoPageCtrl',
		backdrop : "static"
	...
	var addUserPage = $modal({
		scope : $scope,
		templateUrl : 'packages/sys/views/user/addUser.html',
		show : false,
		container : '#userlist',
...
function userInfoPageCtrl($scope, $http, $q, $filter, $modal,$rootScope) {
	...
	$scope.commitUpdateInfo = function(){
		...
		var updateUserResult = pageService($http, $q, 'UserController',
				'updateUser', null, null, paramsJson);
		...
		updateUserResult.then(function(success) {
			...
			$scope.queryUserByDept($scope.deptId)						
		}, function(error) {
