 ...
 */
function ImplListCtrl($scope, $http, $q, $listService) {
    ...
    $scope.prepareToAdd = function() {
        var modalScope = $("div[ng-controller='ImplModifyCtrl']").scope();
        modalScope.impl = {
        ...
        modalScope.title = "增加实施人员";
        modalScope.method = "create";
    };

    $scope.prepareToUpdate = function(item) {
        var modalScope = $("div[ng-controller='ImplModifyCtrl']").scope();
        modalScope.impl = item;
        modalScope.title = "更新实施人员";
